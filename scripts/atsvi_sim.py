...
def run_simulation():
    """运行 C++ 仿真节点"""
    config_file = '/home/space/pino_clion/pino_ws/src/ctsvi/config/atsvi_params.yaml'

    print("Starting Variational Integrator simulation...")
    try:
        result = subprocess.run([
            'ros2', 'run', 'ctsvi', 'atsvi_node',
...
def plot_results():
    ...
    # ---------- 1. 读取数据 ----------
    csv_dir = '/home/space/pino_clion/pino_ws/src/ctsvi/csv/atsvi/'
