...
int main(int argc, char** argv)
{
    ...
    // Save CSVs into parameterized folder including lyap params: src/vi/csv/q<q>_dt<dt>_T<T>_a<alpha>_b<beta>/atsvi_ad/
    ...
    std::string csv_dir = std::string("src/vi/csv/") + params_label + std::string("/atsvi_ad/");
